package com.ppcb.cafemerchant.common.components.constant;
...
public enum StatusCode {
    ...
    PASSWORD_MUST_BE_ENCRYPTED(1004, "Password must be encrypted!"),
    BAD_REQUEST(1005, "Bad Request"),
    BAD_CREDENTIALS(1006, "Password is incorrect"),
    USER_DISABLED(1007, "User account is disabled"),
    USER_LOCKED(1008, "User account is locked"),
    USER_EXPIRED(1009, "User account has expired"),
    CREDENTIALS_EXPIRED(1010, "User credentials have expired"),
    ...
    INVALID_AUTH_TOKEN(2006, "Invalid authentication token: {0}"),
    INVALID_LOGIN_TYPE(2007, "Invalid login type for link authentication"),

    // User related errors (3000-3999)
    USER_NOT_FOUND(3000, "User not found with id: {0}"),
    FILE_NOT_FOUND(3001, "File not found"),
    FILE_SIZE_EXCEED(3002, "File size exceeds the 10MB limit"),
    INVALID_FILE_NAME(3003, "Invalid file name"),
    FAIL_UPLOAD_FILE(3004, "Could not create upload directory"),
    FAIL_REMOVE_FILE(3005, "Failed to delete old file"),
