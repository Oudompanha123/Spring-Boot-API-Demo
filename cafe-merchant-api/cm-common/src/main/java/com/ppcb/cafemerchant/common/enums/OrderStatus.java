 ...
 */
public enum OrderStatus implements GenericEnum<OrderStatus, String> {
    PENDING("pending"),
    COMPLETED("completed"),
    ;
    ...
    public static OrderStatus fromValue(String value) {
        for(OrderStatus my: OrderStatus.values()) {
    ...
    public static class Converter extends AbstractEnumConverter<OrderStatus, String> {
